...
CFLAGS_CortexM3= -mcpu=cortex-m3 -mthumb -I. -IGenerated_Source/PSoC5 -Wa,-alh=$(OUT_DIR_CortexM3)/$(basename $(<F)).lst -funsigned-char -g -D DEBUG -D CY_CORE_ID=0 -Wall -ffunction-sections -ffat-lto-objects -Og
