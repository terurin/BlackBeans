// ======================================================================
// BlackBeans.v generated from TopDesign.cysch
// 03/31/2019 at 05:31
...
`ifdef WARP
`define CY_BLK_DIR "D:\user\teru\Documents\PSoC Creator\BlackBeans\BlackBeans.cydsn\BLDCDivider"
`include "D:\user\teru\Documents\PSoC Creator\BlackBeans\BlackBeans.cydsn\BLDCDivider\BLDCDivider.v"
`else
`define CY_BLK_DIR "D:\user\teru\Documents\PSoC Creator\BlackBeans\BlackBeans.cydsn\BLDCDivider"
`include "D:\user\teru\Documents\PSoC Creator\BlackBeans\BlackBeans.cydsn\BLDCDivider\BLDCDivider.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\user\teru\Documents\PSoC Creator\BlackBeans\BlackBeans.cydsn\HallSensorHead"
`include "D:\user\teru\Documents\PSoC Creator\BlackBeans\BlackBeans.cydsn\HallSensorHead\HallSensorHead.v"
`else
`define CY_BLK_DIR "D:\user\teru\Documents\PSoC Creator\BlackBeans\BlackBeans.cydsn\HallSensorHead"
`include "D:\user\teru\Documents\PSoC Creator\BlackBeans\BlackBeans.cydsn\HallSensorHead\HallSensorHead.v"
`endif
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=2, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=255, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=255, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=255, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=8, RunMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=true, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=HallEncoder, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BLDCMotor_1:HallEncoder, CY_INSTANCE_SHORT_NAME=HallEncoder, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=BLDCMotor_1_HallEncoder, )
...
`ifdef WARP
`define CY_BLK_DIR "D:\user\teru\Documents\PSoC Creator\BlackBeans\BlackBeans.cydsn\QEIHead"
`include "D:\user\teru\Documents\PSoC Creator\BlackBeans\BlackBeans.cydsn\QEIHead\QEIHead.v"
`else
`define CY_BLK_DIR "D:\user\teru\Documents\PSoC Creator\BlackBeans\BlackBeans.cydsn\QEIHead"
`include "D:\user\teru\Documents\PSoC Creator\BlackBeans\BlackBeans.cydsn\QEIHead\QEIHead.v"
`endif

// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=2, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=255, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=255, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=255, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=8, RunMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=true, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=QEIEncoder, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BLDCMotor_1:QEIEncoder, CY_INSTANCE_SHORT_NAME=QEIEncoder, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=BLDCMotor_1_QEIEncoder, )
...
// BLDCMotor(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=BLDCMotor, CY_CONFIG_TITLE=BLDCMotor_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BLDCMotor_1, CY_INSTANCE_SHORT_NAME=BLDCMotor_1, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=BLDCMotor_1, )
module BLDCMotor_5 (
    X,
    Y,
    halls,
    ...
    HallSensorHead HallSensorHead (
        .halls(halls[2:0]),
        .clock(clock),
        .up(Net_53),
        .down(Net_54));

    Counter_v3_0_2 HallEncoder (
        .reset(reset),
        .tc(Net_15),
        .comp(Net_16),
        .clock(clock),
        ...
        .up_ndown(1'b1),
        .count(1'b0));
    defparam HallEncoder.CaptureMode = 0;
    defparam HallEncoder.ClockMode = 2;
    defparam HallEncoder.CompareMode = 1;
    defparam HallEncoder.CompareStatusEdgeSense = 1;
    defparam HallEncoder.EnableMode = 0;
    defparam HallEncoder.ReloadOnCapture = 0;
    defparam HallEncoder.ReloadOnCompare = 0;
    defparam HallEncoder.ReloadOnOverUnder = 1;
    defparam HallEncoder.ReloadOnReset = 1;
    defparam HallEncoder.Resolution = 8;
    defparam HallEncoder.RunMode = 0;
    defparam HallEncoder.UseInterrupt = 1;
    ...
    Counter_v3_0_4 QEIEncoder (
        ...
        .up_ndown(1'b1),
        .count(1'b0));
    defparam QEIEncoder.CaptureMode = 0;
    defparam QEIEncoder.ClockMode = 2;
    defparam QEIEncoder.CompareMode = 1;
    defparam QEIEncoder.CompareStatusEdgeSense = 1;
    defparam QEIEncoder.EnableMode = 0;
    defparam QEIEncoder.ReloadOnCapture = 0;
    defparam QEIEncoder.ReloadOnCompare = 0;
    defparam QEIEncoder.ReloadOnOverUnder = 1;
    defparam QEIEncoder.ReloadOnReset = 1;
    defparam QEIEncoder.Resolution = 8;
    defparam QEIEncoder.RunMode = 0;
    defparam QEIEncoder.UseInterrupt = 1;
...
module top ;
	...
	wire [0:0] tmpOE__M1X_net;
	wire [0:0] tmpIO_0__M1X_net;
	wire [0:0] tmpINTERRUPT_0__M1X_net;
	electrical [0:0] tmpSIOVREF__M1X_net;
	...
	cy_psoc3_pins_v1_10
		...
		M1X
		 (.oe(tmpOE__M1X_net),
		  .y({1'b0}),
		  .fb({Net_1707}),
		  .io({tmpIO_0__M1X_net[0:0]}),
		  .siovref(tmpSIOVREF__M1X_net),
		  .interrupt({tmpINTERRUPT_0__M1X_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M1X_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    BLDCMotor_5 BLDCMotor_1 (
        .X(Net_1707),
        .Y(Net_1691),
        .halls(Net_1692[2:0]),
        .clock(Net_1772),
	...
	wire [2:0] tmpOE__M1nReset_net;
	wire [2:0] tmpFB_2__M1nReset_net;
	wire [2:0] tmpIO_2__M1nReset_net;
	wire [0:0] tmpINTERRUPT_0__M1nReset_net;
	electrical [0:0] tmpSIOVREF__M1nReset_net;

	cy_psoc3_pins_v1_10
		#(.id("71819f36-39a1-48da-aeda-c8cc43388bde"),
		...
		M1nReset
		 (.oe(tmpOE__M1nReset_net),
		  .y({Net_1705[2:0]}),
		  .fb({tmpFB_2__M1nReset_net[2:0]}),
		  .io({tmpIO_2__M1nReset_net[2:0]}),
		  .siovref(tmpSIOVREF__M1nReset_net),
		  .interrupt({tmpINTERRUPT_0__M1nReset_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M1nReset_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};

	wire [2:0] tmpOE__M1PWMs_net;
	wire [2:0] tmpFB_2__M1PWMs_net;
	wire [2:0] tmpIO_2__M1PWMs_net;
	wire [0:0] tmpINTERRUPT_0__M1PWMs_net;
	electrical [0:0] tmpSIOVREF__M1PWMs_net;

	cy_psoc3_pins_v1_10
		#(.id("a987342b-66e3-45d3-860a-994e96914f4d"),
		  .drive_mode(9'b110_110_110),
		  .ibuf_enabled(3'b1_1_1),
		  .init_dr_st(3'b0_0_0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(6'b00_00_00))
		M1PWMs
		 (.oe(tmpOE__M1PWMs_net),
		  .y({Net_1704[2:0]}),
		  .fb({tmpFB_2__M1PWMs_net[2:0]}),
		  .io({tmpIO_2__M1PWMs_net[2:0]}),
		  .siovref(tmpSIOVREF__M1PWMs_net),
		  .interrupt({tmpINTERRUPT_0__M1PWMs_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M1PWMs_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};


    assign Net_1705[2:0] = ~Net_1729[2:0];


	cy_clock_v1_0
		#(.id("bc1e4543-bfe6-4321-be09-4d7e1d4532d2"),
	...
	wire [0:0] tmpOE__M1Y_net;
	wire [0:0] tmpIO_0__M1Y_net;
	wire [0:0] tmpINTERRUPT_0__M1Y_net;
	electrical [0:0] tmpSIOVREF__M1Y_net;

	cy_psoc3_pins_v1_10
		#(.id("7fb09e17-0718-4e39-965a-0d93483ca033"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		M1Y
		 (.oe(tmpOE__M1Y_net),
		  .y({1'b0}),
		  .fb({Net_1691}),
		  .io({tmpIO_0__M1Y_net[0:0]}),
		  .siovref(tmpSIOVREF__M1Y_net),
		  .interrupt({tmpINTERRUPT_0__M1Y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M1Y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [2:0] tmpOE__M1H_net;
	wire [2:0] tmpIO_2__M1H_net;
	wire [0:0] tmpINTERRUPT_0__M1H_net;
	electrical [0:0] tmpSIOVREF__M1H_net;

	cy_psoc3_pins_v1_10
		#(.id("f3183aec-4823-4ef1-b896-dba8cd4daf30"),
		...
		M1H
		 (.oe(tmpOE__M1H_net),
		  .y({3'b0}),
		  .fb({Net_1692[2:0]}),
		  .io({tmpIO_2__M1H_net[2:0]}),
		  .siovref(tmpSIOVREF__M1H_net),
		  .interrupt({tmpINTERRUPT_0__M1H_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M1H_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};
